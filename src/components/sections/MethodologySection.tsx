    ...
    <SectionContainer id="methodology" className="bg-black">
      ...
      <div className="mt-20 text-center">
        <Card className="bg-gradient-to-r from-[#febe5d]/10 via-[#febe5d]/5 to-[#febe5d]/10 border-[#febe5d]/30">
          <div className="py-8">
            <p className="text-gray-400 mb-4 uppercase tracking-wider text-sm">Projected Results</p>
            <h3 className="text-6xl md:text-7xl font-bold text-gradient-gold mb-4">
              1,000 Million THB
            </h3>
            <p className="text-xl text-gray-300">Total Growth in 2025</p>
          </div>
        </Card>
      </div>
    </SectionContainer>
